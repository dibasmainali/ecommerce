...
//   const flashSaleProducts = [...laptopProducts, ...mobileProducts, ...monitorProducts];

//   return (
//     <div className="bg-red-500 p-6 rounded-lg mb-8 text-center">
//       <h2 className="text-3xl font-bold text-white mb-4">Flash Sale - Limited Time Offer!</h2>
//       <div className="flex overflow-x-auto scrollbar-thin scrollbar-thumb-gray-500 gap-11 scrollbar-track-gray-200">
//         {flashSaleProducts.map((product) => (
//           <div key={product.id} className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition flex-shrink-0 w-64">
//             <img
//               src={product.image}
//               alt={product.name}
...
const FlashSale = () => {
  ...
  return (
    <div className="bg-blue-100 p-6 rounded-lg mb-8 text-center">
      ...
      <h2 className="text-3xl font-bold text-black mb-4">Flash Sale - Limited Time Offer!</h2>
      <div className="flex overflow-x-auto scrollbar-thin scrollbar-thumb-gray-500 gap-10 scrollbar-track-gray-200">
        {flashSaleProducts.map((product) => (
          <div key={product.id} className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition flex-shrink-0 w-64">
            ...
            <div className="text-red-500 line-through">{product.priceRange}</div>
            <span className="text-green-500 font-bold">
              ${(product.priceRange * 0.9).toFixed(2)}
            </span>
          </div>
        ))}
      </div>
