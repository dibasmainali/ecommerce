      ...
      <div className="container mx-auto px-4 md:px-8 mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-3">
          {displayedMonitors.length > 0 ? (
            displayedMonitors.map((monitor) => (
              <div
                key={monitor.id}
                className="bg-white border border-blue-200 p-4 rounded-lg shadow-xl transition-transform transform hover:scale-105 hover:shadow-2xl"
              >
                <img
                  src={monitor.imageUrl}
                  alt={monitor.name}
                ...
                />
                <h2 className="text-lg font-semibold text-black-900 mb-2">
                  {monitor.name}
                </h2>
            ...
            <p className="col-span-1 md:col-span-3 text-center text-black-600">
              No monitors found.
            </p>
          )}
        </div>
        ...
        <div className="text-center mt-8">
          <button
            ...
            className="bg-blue-400 hover:bg-blue-500 text-white font-semibold py-3 px-6 rounded-lg transition ease-in-out"
          >
            {showAll ? "Show Less" : "Show All"}
          </button>
        </div>
