...
//             />
//             <button
//               className="bg-blue-400 hover:bg-blue-500 text-white font-semibold py-2 px-4 rounded-r-lg transition duration-300 ease-in-out transform hover:scale-105 ring-blue-500"
//             >
//               Search
//             </button>
//           </div>
...
//                         id: mobile.id,
//                         name: mobile.name,
//                         price: mobile.price, // Assuming price is a string like "$499"
