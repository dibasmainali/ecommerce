const monitors = [
    {
      ...
      panelType: "IPS",
      imageUrl: "https://via.placeholder.com/300x200?text=Dell+UltraSharp+U2720Q",
      description:
    ...
    },
    {
      ...
      panelType: "IPS",
      imageUrl: "https://via.placeholder.com/300x200?text=LG+34WN80C-B",
      description:
    ...
    },
    {
      ...
      panelType: "IPS",
      imageUrl: "https://via.placeholder.com/300x200?text=ASUS+ROG+Swift+PG279Q",
      description:
    ...
    },
    {
      ...
      resolution: "2560 x 1440 (QHD)",
      panelType: "VA",
      imageUrl: "https://via.placeholder.com/300x200?text=Samsung+Odyssey+G7",
      description:
    ...
    },
    {
      ...
      resolution: "3840 x 2160 (4K UHD)",
      panelType: "IPS",
      imageUrl: "https://via.placeholder.com/300x200?text=Acer+Predator+X27",
      description:
    ...
    },
    {
      ...
      resolution: "3840 x 2160 (4K UHD)",
      panelType: "IPS",
      imageUrl: "https://via.placeholder.com/300x200?text=BenQ+PD3200U",
      description:
    ...
    },
    {
      ...
      resolution: "2560 x 1440 (QHD)",
      panelType: "TN",
      imageUrl: "https://via.placeholder.com/300x200?text=HP+Omen+X+27",
      description:
    ...
    },
    {
      ...
      panelType: "IPS",
      imageUrl: "https://via.placeholder.com/300x200?text=ViewSonic+VP3881",
      description:
    ...
    },
    {
      ...
      resolution: "2560 x 1440 (QHD)",
      panelType: "IPS",
      imageUrl: "https://via.placeholder.com/300x200?text=Gigabyte+AORUS+FI27Q",
      description:
    ...
    },
    {
      ...
      resolution: "2560 x 1440 (QHD)",
      panelType: "VA",
      imageUrl: "https://via.placeholder.com/300x200?text=MSI+Optix+MAG272CQR",
      description:
        'The MSI Optix MAG272CQR is a 27" curved gaming monitor with a QHD resolution and 165Hz refresh rate. Its VA panel provides deep blacks and vibrant colors, enhancing the gaming experience.',
    },
  ];
